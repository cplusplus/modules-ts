...
\begin{itemize}
    ...
    \exitnote
    \added{It is implementation-defined whether the source for module interface 
    units for modules on which the current translation unit has an interface
...
\begin{std.txt}\color{addclr}
    ...
    \end{itemize}
    The \term{abstract semantics graph of a module} is the subgraph of
