...
\nonterminal{translation-unit}:\br
    ...
    \added{preamble top-level-declaration-seq\opt private-module-fragment\opt}
\end{bnf}

\begin{bnf}
\added{\nonterminal{preamble}:\br
    global-module-fragment\opt module-declaration\br
    preamble module-import-declaration}
\end{bnf}
...
\alinea
\added{A \grammarterm{private-module-fragment} shall only appear
...
\begin{std.txt}
  \begin{itemize}
    ...
    \begin{itemize}
      \color{addclr}
      \item[---] \added{it is declared \tcode{extern}, or}
