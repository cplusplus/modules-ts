...
\begin{tcolorbox}[breakable,colback=red!5!white,colframe=red!75!black,title=Before]
}{
\end{tcolorbox}
}

\newenvironment{after}{
\begin{tcolorbox}[breakable,colback=green!5!white,colframe=green!75!black,title=After]
}{
\end{tcolorbox}
}
