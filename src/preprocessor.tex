...
\grammarterm{preprocessing-token}{s} in the \grammarterm{pp-balanced-token-seq}
...
forms an \grammarterm{import-seq}, and the \tcode{import} token is not
within the \grammarterm{header-name-tokens} or
\grammarterm{pp-import-suffix} of another \grammarterm{pp-import}.
