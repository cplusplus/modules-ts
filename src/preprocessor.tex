...
\nonterminal{pp-import}:\br
  \terminal{import}\opt{} header-name pp-decl-suffix\opt{} \terminal{;}
\end{bnf}
...
\alinea
If an imported macro is replaced (\stdref{cpp.replace}{14.3})
or is named by a \grammarterm{defined-macro-expression}
outside of a \grammarterm{pp-global-module-fragment},
there shall be no \grammarterm{pp-import}{s} with a
