...
and the other is a member or friend declaration of $C$, or
\item
one of $D$ and $M$ declares an enumeration $E$
and the other is an enumerator of $E$, or
\item
$D$ declares a function or variable and $M$ is declared in $D$, or
\item
...
\grammarterm{alias-declaration}{s},
\tcode{typedef} declarations,
\grammarterm{using-declaration}{s}, and
\grammarterm{namespace-alias-declaration}{s}
...
template<typename T> int use_f() {
  ...
  return f(x);               // \tcode{N::f} and \tcode{N::d} are decl-reachable from \tcode{use_f}
}
